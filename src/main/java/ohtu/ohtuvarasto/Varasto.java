...
public class Varasto {
    ...
    public Varasto(double tilavuus, double alkuSaldo) { // kuormitetaan
        ...
        this.saldo = saldonTarkastaja(tilavuus, alkuSaldo);

    }

    private double saldonTarkastaja(double tilavuus, double alkuSaldo) {
        double oikeaSaldo = 0.0;
        if (alkuSaldo < 0.0) {
            oikeaSaldo = 0.0;
        } else if (alkuSaldo <= tilavuus) {
            oikeaSaldo = alkuSaldo;
        } else {
